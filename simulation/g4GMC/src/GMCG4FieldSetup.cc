...
GMCG4FieldSetup::GMCG4FieldSetup(G4ThreeVector fieldVector)
 : fFieldManager(0),
   fChordFinder(0),
   fEquation(0),
   fMagneticField(new GMCG4MagneticField(fieldVector)),
   fStepper(0),
   fStepperType(0),
   fMinStep(0.),
   fFieldMessenger(0)
{
  G4cout << " GMCG4FieldSetup: magnetic field set to Uniform( "
         << fieldVector << " ) " << G4endl;
  InitialiseAll();
}
...
GMCG4FieldSetup::GMCG4FieldSetup()
 : fFieldManager(0),
   fChordFinder(0),
   fEquation(0),
   fMagneticField(new GMCG4MagneticField(G4ThreeVector())),
   fStepper(0),
   fStepperType(0),
   fMinStep(0.),
   fFieldMessenger(0)
{
  G4cout << " GMCG4FieldSetup: magnetic field set to Uniform( 0.0, 0, 0 ) "
         << G4endl;
  InitialiseAll();
}
...
void GMCG4FieldSetup::InitialiseAll()
{
  fFieldMessenger = new GMCG4FieldMessenger(this);
...
void GMCG4FieldSetup::CreateStepperAndChordFinder()
{
  // Update field
...
void GMCG4FieldSetup::SetStepper()
{
...
void GMCG4FieldSetup::SetFieldValue(G4double fieldStrength)
{
  ...
  if ( fieldStrength != 0.0 ) {
    ...
    if ( fMagneticField == 0 )
      ...
      G4Exception("GMCG4FieldSetup::SetFieldValue(double)",
...
void GMCG4FieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
void GMCG4FieldSetup::SetMaxRhoValue(G4double maxrho)
{
  // Set the value of the Global Field
  if(fMagneticField)
...
G4FieldManager* GMCG4FieldSetup::GetGlobalFieldManager()
{
  //  Utility method
