...
namespace phcv {
  ...
  PHCVradSD::PHCVradSD(const G4String &name, const G4String& hitsCollectionName, const crd::SimpleConfig& config) :
...
//          }
  ...
  G4bool PHCVradSD::ProcessHits(G4Step* aStep, G4TouchableHistory* ){
...
//                                          << _currentSize << endl;
          ...
          _shell = atoi(volName.substr(6,3).c_str());
          _layer = atoi(volName.substr(10,2).c_str());
