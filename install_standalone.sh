...
export GENFIT2SYS=$STANDALONE_INSTALL_DIR/LOCAL/GENFIT/build
export GENFIT=$STANDALONE_INSTALL_DIR/LOCAL/GENFIT/GenFit
cd $GENFIT
./makeEnv.sh
source env.sh
cd ..
...
string2="export GENFIT2SYS=$GENFIT2SYS"
sed -i "s|$string1|$string2|g" ./envGMC.sh
